...
if __name__ == "__main__":
    ...
    parser.add_argument('-if', '--input-format', help='Input format', default=None, required=True)
    parser.add_argument('-o', '--output', help='Output folder', default=None, required=True)
    parser.add_argument('-of', '--output-format', help='Output format', default=None, required=True)
